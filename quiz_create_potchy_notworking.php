							...
							<aside id="quiz_links">
								...
								<?php
									//if (isset($_SESSION['login_user']) && !empty($_SESSION['login_user'])) {
										...
										echo '</form>';
										echo '<input type="button" class="btn btn-add" id="add_button" value="Add a Question" />';
										echo '<input type="button" class="btn btn-create" id="submit_button" value="Create Quiz" />';
										echo '<input type="button" class="btn btn-save" id="save_button" value="Save" />';
