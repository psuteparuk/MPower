			...
			$(document).ready(function(){
				...
				$("#add_button").click(function(){
					$("#quiz_create_form").append(
						...
						'<input style="float:right;" type="button" class="btn btn-danger" id="remove_button-' + numQuestions + '" value="Remove" />' + 
				...
				$("#submit_button").click(function(){
					for (var i = 0; i < indQuestions.length; ++i)
						$("#quiz_create_form").append(
							'<input type="hidden" name="indQuestions[]" value="' + indQuestions[i] + '">'
						);
							...
							<aside id="quiz_links">
								...
								<?php
									//if (isset($_SESSION['login_user']) && !empty($_SESSION['login_user'])) {
										...
										echo '<form action="quiz_teacher_submit.php" method="post" id="quiz_create_form">';
										echo '<div class="quiz_create">';
										echo '<label for="title_input">Title*</label>';
										echo '<input type="text" id="title_input" name="title" size="25" placeholder="Algebra-I" />';
										echo '<label for="timelimit_minute_input">Time Limit</label>';
										echo '<input type="text" class="time_input" id="timelimit_minute_input" name="timelimit_minute" size="8" placeholder="0" />mins&nbsp;';
										echo '<input type="text" class="time_input" id="timelimit_second_input" name="timelimit_second" size="8" placeholder="0" />secs&nbsp;';
										echo '<br /><br />';
										...
										echo '</form>';
										echo '<input type="button" class="btn btn-primary" id="add_button" value="Add a Question" />';
										echo '<input type="button" class="btn btn-success" id="submit_button" value="Create Quiz" />';
										echo '<input type="button" class="btn btn-warning" id="save_button" value="Save" />';
										echo '<p id="show_num_questions">Number of Questions: 0</p>';
										mysql_close();
									//}
								?>
								</nav>
