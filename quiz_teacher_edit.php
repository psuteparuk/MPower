...
<html lang="en">
	...
	<body>
		<?php
			if (!isset($editid)) { echo 'Permission Denied'; die(); }
		?>
					...
					<div id="content">
						<div id="quiz_header_div">
							<header id="quiz_header">
								...
								if (isset($viewid)) {
									...
									$quiztitle_query = mysql_query('SELECT * FROM quiz WHERE id='.$editid);
						...
						<div id="quiz_content">
							...
							//if (isset($_SESSION['login_user']) && !empty($_SESSION['login_user'])) {
								...
								$questions_query = mysql_query('SELECT * FROM question WHERE quizid='.$editid.' ORDER BY id');
								...
								echo '<td colspan="2">';
								echo '<input type="button" class="btn btn-edit" value="Edit" onclick="window.location.href=\'quiz.php?edit='.$editid.'\';" />';
